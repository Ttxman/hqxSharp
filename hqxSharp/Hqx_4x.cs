...
#pragma warning disable CC0120 // Your Switch maybe include default clause
					switch (pattern) {
						...
						case 165: {
								...
								*(dp + 1) = Interpolation.Mix5To2To1(middle, w[1], w[3]);
								*(dp + 2) = Interpolation.Mix5To2To1(middle, w[1], w[5]);
								*(dp + 3) = Interpolation.Mix2To1To1(middle, w[1], w[5]);
								*(dp + dpL) = Interpolation.Mix5To2To1(middle, w[3], w[1]);
								...
								*(dp + dpL + dpL + 3) = Interpolation.Mix5To2To1(middle, w[5], w[7]);
								*(dp + dpL + dpL + dpL) = Interpolation.Mix2To1To1(middle, w[7], w[3]);
								*(dp + dpL + dpL + dpL + 1) = Interpolation.Mix5To2To1(middle, w[7], w[3]);
								*(dp + dpL + dpL + dpL + 2) = Interpolation.Mix5To2To1(middle, w[7], w[5]);
						...
						case 49: {
								*(dp) = Interpolation.Mix2To1To1(middle, w[1], w[3]);
								*(dp + 1) = Interpolation.Mix5To2To1(middle, w[1], w[3]);
								*(dp + 2) = Interpolation.Mix5To2To1(middle, w[1], w[2]);
								*(dp + 3) = Interpolation.Mix5To3(middle, w[2]);
								*(dp + dpL) = Interpolation.Mix5To2To1(middle, w[3], w[1]);
								*(dp + dpL + 1) = Interpolation.Mix6To1To1(middle, w[3], w[1]);
								*(dp + dpL + 2) = Interpolation.Mix7To1(middle, w[2]);
								...
								*(dp + dpL + dpL + dpL) = Interpolation.Mix2To1To1(middle, w[7], w[3]);
								*(dp + dpL + dpL + dpL + 1) = Interpolation.Mix5To2To1(middle, w[7], w[3]);
								*(dp + dpL + dpL + dpL + 2) = Interpolation.Mix5To2To1(middle, w[7], w[8]);
						...
						case 140: {
								*(dp) = Interpolation.Mix5To3(middle, w[0]);
								*(dp + 1) = Interpolation.Mix5To2To1(middle, w[1], w[0]);
								*(dp + 2) = Interpolation.Mix5To2To1(middle, w[1], w[5]);
								*(dp + 3) = Interpolation.Mix2To1To1(middle, w[1], w[5]);
								...
								*(dp + dpL + dpL + 3) = Interpolation.Mix5To2To1(middle, w[5], w[7]);
								*(dp + dpL + dpL + dpL) = Interpolation.Mix5To3(middle, w[6]);
								*(dp + dpL + dpL + dpL + 1) = Interpolation.Mix5To2To1(middle, w[7], w[6]);
								*(dp + dpL + dpL + dpL + 2) = Interpolation.Mix5To2To1(middle, w[7], w[5]);
								*(dp + dpL + dpL + dpL + 3) = Interpolation.Mix2To1To1(middle, w[7], w[5]);
								break;
							}
						...
						case 53: {
								*(dp) = Interpolation.Mix2To1To1(middle, w[1], w[3]);
								*(dp + 1) = Interpolation.Mix5To2To1(middle, w[1], w[3]);
								*(dp + 2) = Interpolation.Mix5To3(middle, w[1]);
						...
						case 177: {
								...
								*(dp + dpL + dpL + dpL) = Interpolation.Mix2To1To1(middle, w[7], w[3]);
								*(dp + dpL + dpL + dpL + 1) = Interpolation.Mix5To2To1(middle, w[7], w[3]);
								*(dp + dpL + dpL + dpL + 2) = Interpolation.Mix5To3(middle, w[7]);
						...
						case 172: {
								...
								*(dp + dpL + dpL + dpL + 1) = Interpolation.Mix5To3(middle, w[7]);
								*(dp + dpL + dpL + dpL + 2) = Interpolation.Mix5To2To1(middle, w[7], w[5]);
								*(dp + dpL + dpL + dpL + 3) = Interpolation.Mix2To1To1(middle, w[7], w[5]);
								break;
							}
						...
						case 141: {
								...
								*(dp + 1) = Interpolation.Mix5To3(middle, w[1]);
								*(dp + 2) = Interpolation.Mix5To2To1(middle, w[1], w[5]);
								*(dp + 3) = Interpolation.Mix2To1To1(middle, w[1], w[5]);
						...
						case 51: {
								if (Diff(w[1], w[5], trY, trU, trV, trA)) {
									...
									*(dp + 3) = Interpolation.MixEven(w[1], w[5]);
									*(dp + dpL + 2) = Interpolation.Mix6To1To1(middle, w[5], w[1]);
									*(dp + dpL + 3) = Interpolation.Mix2To1To1(w[5], middle, w[1]);
								}
								*(dp + dpL) = Interpolation.Mix5To3(middle, w[3]);
								*(dp + dpL + 1) = Interpolation.Mix7To1(middle, w[3]);
								*(dp + dpL + dpL) = Interpolation.Mix5To2To1(middle, w[3], w[7]);
						...
						case 178: {
								...
								*(dp + 1) = Interpolation.Mix3To1(middle, w[0]);
								if (Diff(w[1], w[5], trY, trU, trV, trA)) {
									...
									*(dp + 2) = Interpolation.Mix2To1To1(w[1], middle, w[5]);
									*(dp + 3) = Interpolation.MixEven(w[1], w[5]);
									*(dp + dpL + 2) = Interpolation.Mix6To1To1(middle, w[5], w[1]);
						...
						case 204: {
								...
								*(dp + dpL + 3) = Interpolation.Mix5To2To1(middle, w[5], w[1]);
								if (Diff(w[7], w[3], trY, trU, trV, trA)) {
									...
									*(dp + dpL + dpL) = Interpolation.Mix2To1To1(w[3], middle, w[7]);
									*(dp + dpL + dpL + 1) = Interpolation.Mix6To1To1(middle, w[3], w[7]);
									*(dp + dpL + dpL + dpL) = Interpolation.MixEven(w[7], w[3]);
						...
						case 77: {
								if (Diff(w[7], w[3], trY, trU, trV, trA)) {
									...
									*(dp + dpL + dpL + 1) = Interpolation.Mix6To1To1(middle, w[3], w[7]);
									*(dp + dpL + dpL + dpL) = Interpolation.MixEven(w[7], w[3]);
									*(dp + dpL + dpL + dpL + 1) = Interpolation.Mix2To1To1(w[7], middle, w[3]);
								}
								*(dp + 1) = Interpolation.Mix5To3(middle, w[1]);
								*(dp + 2) = Interpolation.Mix5To2To1(middle, w[1], w[5]);
								*(dp + 3) = Interpolation.Mix2To1To1(middle, w[1], w[5]);
