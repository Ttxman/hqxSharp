...
#pragma warning disable CC0120 // Your Switch maybe include default clause
					switch (pattern) {
						...
						case 50: {
								*dp = Interpolation.Mix2To1To1(middle, w[0], w[3]);
								*(dp + 1) = Diff(w[1], w[5], trY, trU, trV, trA) ? Interpolation.Mix3To1(middle, w[2]) : Interpolation.Mix2To1To1(middle, w[1], w[5]);
								*(dp + dpL) = Interpolation.Mix2To1To1(middle, w[7], w[3]);
								*(dp + dpL + 1) = Interpolation.Mix2To1To1(middle, w[8], w[7]);
								break;
							}
						...
						case 81: {
								...
								*(dp + 1) = Interpolation.Mix2To1To1(middle, w[2], w[1]);
								*(dp + dpL) = Interpolation.Mix2To1To1(middle, w[6], w[3]);
								*(dp + dpL + 1) = Diff(w[5], w[7], trY, trU, trV, trA) ? Interpolation.Mix3To1(middle, w[8]) : Interpolation.Mix2To1To1(middle, w[5], w[7]);
								break;
							}
						case 72:
						case 76: {
								*dp = Interpolation.Mix2To1To1(middle, w[0], w[1]);
								*(dp + 1) = Interpolation.Mix2To1To1(middle, w[1], w[5]);
								*(dp + dpL) = Diff(w[7], w[3], trY, trU, trV, trA) ? Interpolation.Mix3To1(middle, w[6]) : Interpolation.Mix2To1To1(middle, w[7], w[3]);
								*(dp + dpL + 1) = Interpolation.Mix2To1To1(middle, w[8], w[5]);
								break;
							}
						case 10:
						...
						case 178: {
								*dp = Interpolation.Mix2To1To1(middle, w[0], w[3]);
								if (Diff(w[1], w[5], trY, trU, trV, trA)) {
									...
									*(dp + 1) = Interpolation.Mix2To3To3(middle, w[1], w[5]);
									*(dp + dpL + 1) = Interpolation.Mix5To2To1(middle, w[5], w[7]);
								}
								*(dp + dpL) = Interpolation.Mix2To1To1(middle, w[7], w[3]);
								break;
							}
						...
						case 204: {
								...
								*(dp + 1) = Interpolation.Mix2To1To1(middle, w[1], w[5]);
								if (Diff(w[7], w[3], trY, trU, trV, trA)) {
									...
									*(dp + dpL + 1) = Interpolation.Mix5To2To1(middle, w[7], w[5]);
								}
								break;
							}
						case 73:
						...
						case 170: {
								if (Diff(w[3], w[1], trY, trU, trV, trA)) {
									...
									*(dp + dpL) = Interpolation.Mix5To2To1(middle, w[3], w[7]);
								}
								*(dp + 1) = Interpolation.Mix2To1To1(middle, w[2], w[5]);
								*(dp + dpL + 1) = Interpolation.Mix2To1To1(middle, w[5], w[7]);
								break;
						...
						case 142: {
								if (Diff(w[3], w[1], trY, trU, trV, trA)) {
									...
									*dp = Interpolation.Mix2To3To3(middle, w[3], w[1]);
									*(dp + 1) = Interpolation.Mix5To2To1(middle, w[1], w[5]);
								}
								*(dp + dpL) = Interpolation.Mix2To1To1(middle, w[6], w[7]);
								*(dp + dpL + 1) = Interpolation.Mix2To1To1(middle, w[5], w[7]);
								break;
